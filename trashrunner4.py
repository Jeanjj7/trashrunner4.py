...
# Carrega spritesheet
spritesheet = pygame.image.load("ps.png").convert_alpha()

# Função para cortar os quadros
def cortar_spritesheet(sheet, largura, altura):
    sprites = []
    for i in range(4):  # 4 quadros
...
while True:
    ...
    if estado_jogo == TELA_INICIAL:
        ...
        texto_tempo = fonte_score.render(f"Distância: {score}", True, PRETO)
